...
const routes = [
	...
	{ label: 'Create organization', path: '/super-admin/organizations/create', icon: faPencil },
	{ label: 'Course Categories', path: '/super-admin/course-categories', icon: faDeskpro },
	{ label: 'Create category', path: '/super-admin/course-categories/create', icon: faPencil },
	{ label: 'Courses', path: '/super-admin/courses', icon: faGraduationCap },
	{ label: 'Create course', path: '/super-admin/courses/create', icon: faPencil },
