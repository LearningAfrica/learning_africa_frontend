"use client"
import { LocalStorageKeyType, TokenType } from "@/types/types";
...
class Cookie {
	...
	static setCookieToken = <
		Key extends CookieKeys,
		CookiePayload extends TokenType
	>(
		key: Key,
...
class AppLocalStorage {
	static set<Key extends LocalStorageKeyType>(
		name: Key,
		value: string
	): void {
	...
	static get<P = unknown>(name: LocalStorageKeyType): P | null {
...
export { Cookie, AppLocalStorage };
export default Object.assign({}, Cookie, AppLocalStorage); //});