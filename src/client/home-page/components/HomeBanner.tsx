			...
			<div className=" max-w-7xl mx-auto  w-full grid grid-cols-2 gap-4 p-10 min-h-[80vh] justify-center items-center">
				<div className="flex flex-col gap-4">
					...
					<div className="flex gap-4">
						<NavLink
							...
							className="bg-primary-pk text-white px-8 py-4 rounded-md"
						>
							Get Started
						</NavLink>
						<button className="bg-white text-primary-pk px-8 py-4 rounded-md border-primary border-1">
							Learn More
						</button>
					</div>
				</div>
				<div className="relative">
					<img
						...
						alt="header"
					/>
					<div className="absolute top-0 left-80 -z-[1] animate-ping rounded-full w-40 h-40 bg-primary-pk bg-opacity-50"></div>
					...
					<div className="absolute right-0 bottom-0 rounded-full animate-bounce w-64 -z-[1] h-20 bg-primary-pk bg-opacity-50"></div>
				</div>
			</div>
		</div>
	);
