...
function SuperAdminDashboardReviews() {
	return (
		<div className="flex space-x-4 flex-1 mt-5">
			<div className=" flex justify-start bg-white w-[500px] h-[400px] rounded-lg   flex-col">
				<div className="flex rounded-lg bg-gray-400 px-4 py-2 justify-center items-center mb-2">
					<svg
				...
				<div className="flex flex-col">
					<div className="bg-gray-100">
						<div className="max-w-lg mx-auto my-10 bg-white rounded-lg shadow-md p-5">
							<div className="flex justify-start mb-3 border-gray-400 border-b">
							...
							<div className="flex justify-start space-x-3">
								...
								<div className="flex flex-col space-y-4">
									...
									<small className="text-center text-gray-600 mt-1">
										2 hours ago{' '}
									</small>
								</div>
							</div>
...
export default SuperAdminDashboardReviews;
