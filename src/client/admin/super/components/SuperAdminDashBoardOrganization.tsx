...
function SuperAdminDashBoardOrganization() {
	return (
		<div className="flex flex-col gap-4 py-4 px-4">
			<div className="p-4 bg-white rounded-full flex justify-between">
				...
				<div>
					<NavLink
						to={'/super/dashboard/organization/create'}
						className="bg-primary-pk text-white px-4 py-2 rounded-full"
					>
						+ Create Organization
					</NavLink>
				</div>
...
export default SuperAdminDashBoardOrganization;
