...
import SuperAdminCourseCard from './super-admin-course-category/SuperAdminCourseCard';
const populacourses = [
	{
		name: 'Marketing',
		courses: '25+ Courses',
...
function SuperAdminDashboardCoursesCategory() {
	return (
		<div className="p-2">
			<div className="m-3">
...
export default SuperAdminDashboardCoursesCategory;
