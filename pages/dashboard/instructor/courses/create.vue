				...
				<cn-form-field #="{ componentField }" as="div" :name="'organization'"
					...
					<cn-form-item>
						...
						<cn-select v-bind="componentField">
							...
							<cn-select-content>
								<cn-select-group>
									<cn-select-item :value="org.id" v-for="org of organization.data.value">{{ org.name
										}}</cn-select-item>
								</cn-select-group>
							</cn-select-content>
						</cn-select>
				...
				<cn-form-field #="{ componentField }" as="div" :name="'category'" class="flex flex-col gap-2 w-full">
					<cn-form-item>
						...
						<cn-select v-bind="componentField">
							...
							<cn-select-content>
								<cn-select-group>
									<cn-select-item :value="cat.id" v-for="cat of category.data.value.data">{{ cat.title
										}}</cn-select-item>
								</cn-select-group>
							</cn-select-content>
						</cn-select>
				...
				<cn-form-field #="{ componentField }" as="div" :name="'is_private'" class="flex flex-col gap-2 w-full">
					<cn-form-item>
						...
						<cn-select v-bind="componentField">
							...
							<cn-select-content>
								<cn-select-group>
									<cn-select-item :value="true">Yes </cn-select-item><cn-select-item
										:value="false">No</cn-select-item>
								</cn-select-group>
							</cn-select-content>
						</cn-select>
						<cn-form-message />
