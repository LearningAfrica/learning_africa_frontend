...
<div>
    ...
    <div v-if="courseModule.data.value && courseModule.is_loading.value === false">
        ...
        <div v-if="courseModule.data.value.contents.length === 0">
            <div class="flex flex-col gap-2 p-4">
                <p class="text-center">
	...
	<dashboard-course-add-module-add-content :course_id="Number(router.params.id)" :module_id="Number(router.params.module_id)" :is_create_content_dialog_open="is_add_content_dialog_open" @close="toggleAddContent" />
</div>
</template>
