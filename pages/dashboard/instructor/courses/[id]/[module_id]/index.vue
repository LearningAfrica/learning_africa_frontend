...
<template>
	<div class="py-4">
		...
		<div
			v-else-if="
				!courseModule.is_loading.value && courseModule.data.value
			"
		>
		...
		<div
			v-if="
				courseModule.data.value &&
				courseModule.is_loading.value === false
			"
		>
			...
			<div v-else>
				<div class="flex flex-col gap-2 p-4">
					<div
						v-for="(content, index) of courseModule.data.value
							.contents"
						:key="content.id"
					>
						<dashboard-course-content-card
