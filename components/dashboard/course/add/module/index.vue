...
<template>
  <hui-dialog
    :open="is_create_module_dialog_open"
    @close="emit('close', false)"
    class="fixed inset-0 z-[999] overflow-y-auto"
  >
    <div
      class="flex items-center justify-center min-h-screen w-screen bg-white bg-opacity-70 border"
    >
      <div class="bg-white border p-6 rounded-lg shadow-lg w-full min-h-[20vh] max-w-xl">
        <hui-dialog-panel>
          ...
          <hui-dialog-description class="text-gray-600"> </hui-dialog-description>
          <form
            v-if="!isLoading"
            action=""
