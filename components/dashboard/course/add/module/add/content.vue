...
const submitForm = form.handleSubmit(async (values) => {
	...
	if (values["content_type"] == "image") {
		values["image"] =
			imageUpload.uploaded_files.value["create-course-content-image"][0];
	}
	if (values["content_type"] == "file") {
		values["image"] =
			fileUpload.uploaded_files.value["create-course-content-file"][0];
	}
	try {
	...
	<div>
		<div class="flex items-center justify-center bg-white bg-opacity-70">
			<div class="bg-white p-6 rounded-lg w-full">
				<h1 class="text-xl font-bold text-primary mb-4">
				...
				>
					...
					>
						<cn-form-item>
							<cn-form-label for="content_type"
								>Content type</cn-form-label
							>
					...
					>
						<div class="flex justify-center">
							<img
								...
								:src="
									imageUpload.uploaded_previews.value[
										'create-course-content-image'
									][0].preview
								"
